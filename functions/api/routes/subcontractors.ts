...
const complianceSchema = z.object({
  ...
  criterion_13_verified: boolOrInt,
  criterion_13_notes: z.string().nullable().optional(),
  criterion_14_verified: boolOrInt,
